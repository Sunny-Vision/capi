...
@Secured("RF9025")
@FuncCode("RF9025")
@Controller("SummaryItineraryController")
@RequestMapping("report/SummaryItinerary")
public class SummaryItineraryController extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(SummaryItineraryController.class);
	
	@Autowired
	@Qualifier("SummaryItineraryService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/SummaryItineray/home");
	}
	
	@RequestMapping(value="submitReportRequest")
	public String submitReportRequsest(SummaryItineraryCriteria criteria, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		...
		return "redirect:/report/SummaryItinerary/home";
	}
