...
@Secured("RF9012")
@FuncCode("RF9012")
@Controller("ListOfPackageTourQuotationRecordsController")
@RequestMapping("report/ListOfPackageTourQuotationRecords")
public class ListOfPackageTourQuotationRecordsController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(ListOfPackageTourQuotationRecordsController.class);
	
	@Autowired
	@Qualifier( "ListOfPackageTourQuotationRecordsService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/ListOfPackageTourQuotationRecords/home");
	}
	...
	public String submitReportRequest(ListOfPackageTourQuotationRecordsCriteria criteria, Integer taskType, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, taskType);
		return "redirect:/report/ListOfPackageTourQuotationRecords/home";
	}
