...
@Secured("RF9028")
@FuncCode("RF9028")
@Controller("SummaryOfNightSessionController")
@RequestMapping("report/SummaryOfNightSession")
public class SummaryOfNightSessionController extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(CalendarSummaryController.class);
	
	@Autowired
	@Qualifier("SummaryOfNightSessionService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/SummaryOfNightSession/home");
	}
	
	@RequestMapping(value="submitReportRequest")
	public String submitReportRequest(SummaryOfNightSessionCriteria criteria, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		...
		return "redirect:/report/SummaryOfNightSession/home";
	}
