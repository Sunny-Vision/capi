...
@Secured("RF9013")
@FuncCode("RF9013")
@Controller("SummaryStatisticController")
@RequestMapping("report/SummaryStatistic")
public class SummaryStatisticController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(SummaryStatisticController.class);

	@Autowired
	@Qualifier( "SummaryStatisticService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/SummaryStatistic/home");
	}
	...
	public String submitReportRequest(SummaryStatisticCriteria criteria, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, 2);	
		return "redirect:/report/SummaryStatistic/home";
	}
