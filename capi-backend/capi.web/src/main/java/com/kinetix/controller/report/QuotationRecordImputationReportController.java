...
@Secured("RF9048")
@FuncCode("RF9048")
@Controller("QuotationRecordImputationReportController")
@RequestMapping("report/QuotationRecordImputationReport")
public class QuotationRecordImputationReportController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(QuotationRecordImputationReportController.class);
	
	@Autowired
	@Qualifier( "QuotationRecordImputationReportService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/QuotationRecordImputationReport/home");
	}
	...
	public String submitReportRequest(QuotationRecordImputationReportCriteria criteria, Integer taskType, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, taskType);
		return "redirect:/report/QuotationRecordImputationReport/home";
	}
