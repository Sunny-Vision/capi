...
@Secured("RF9011")
@FuncCode("RF9011")
@Controller("FRAdjustmentController")
@RequestMapping("report/FRAdjustment")
public class FRAdjustmentController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(FRAdjustmentController.class);

	@Autowired
	@Qualifier( "FRAdjustmentService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/FRAdjustment/home");
	}
	...
	public String submitReportRequest(FRAdjustmentCriteria criteria, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, 2);	
		return "redirect:/report/FRAdjustment/home";
	}
