...
@Secured("RF9034")
@FuncCode("RF9034")
@Controller("PECheckSummaryController")
@RequestMapping("report/PECheckSummary")
public class PECheckSummaryController extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(CalendarSummaryController.class);
	
	@Autowired
	@Qualifier("PECheckSummaryService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/PECheckSummary/home");
	}
	
	@RequestMapping(value="submitReportRequest")
	public String submitReportRequest(PECheckSummaryCriteria criteria, Integer taskType, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		...
		return "redirect:/report/PECheckSummary/home";
	}
