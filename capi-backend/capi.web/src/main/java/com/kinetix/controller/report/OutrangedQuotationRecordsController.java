...
@Secured("RF9005")
@FuncCode("RF9005")
@Controller("OutrangedQuotationRecordsController")
@RequestMapping("report/OutrangedQuotationRecords")
public class OutrangedQuotationRecordsController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(OutrangedQuotationRecordsController.class);

	@Autowired
	@Qualifier( "OutrangedQuotationRecordsService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/OutrangedQuotationRecords/home");
	}
	...
	public String submitReportRequest(OutrangedQuotationRecordsCriteria criteria, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, 2);	
		return "redirect:/report/OutrangedQuotationRecords/home";
	}
