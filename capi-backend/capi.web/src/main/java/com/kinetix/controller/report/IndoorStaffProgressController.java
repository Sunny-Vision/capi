...
@Secured("RF9004")
@FuncCode("RF9004")
@Controller("IndoorStaffProgressController")
@RequestMapping("report/IndoorStaffProgress")
public class IndoorStaffProgressController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(IndoorStaffProgressController.class);

	@Autowired
	@Qualifier( "IndoorStaffProgressService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/IndoorStaffProgress/home");
	}
	...
	public String submitReportRequest(IndoorStaffProgressCriteria criteria, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, 2);	
		return "redirect:/report/IndoorStaffProgress/home";
	}
