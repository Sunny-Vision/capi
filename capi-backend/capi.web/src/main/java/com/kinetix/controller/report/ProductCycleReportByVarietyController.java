...
@Secured("RF9042")
@FuncCode("RF9042")
@Controller("ProductCycleReportByVarietyController")
@RequestMapping("report/ProductCycleReportByVariety")
public class ProductCycleReportByVarietyController  extends ReportBaseController{

	private static final Logger logger = LoggerFactory.getLogger(ProductCycleReportByVarietyController.class);
	
	@Autowired
	@Qualifier( "ProductCycleReportByVarietyService")
	...
	public ModelAndView downloadFile(Integer id, ModelAndView mav, RedirectAttributes redirectAttributes, Locale locale, HttpServletResponse response){
		...
		return new ModelAndView("redirect:/report/ProductCycleReportByVariety/home");
	}
	...
	public String submitReportRequest(ProductCycleReportByVarietyCriteria criteria, Integer taskType, Authentication auth, RedirectAttributes redirectAttributes, Locale locale){
		CapiWebAuthenticationDetails detail = (CapiWebAuthenticationDetails)auth.getDetails();
		Integer userId = detail.getUserId();
		this.generateReport(criteria, userId, redirectAttributes, locale, taskType);
		return "redirect:/report/ProductCycleReportByVariety/home";
	}
