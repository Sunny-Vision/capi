...
<t:layout>
		...
		<script>
			$(function() {
				...
				$('.btn-backtrack').click(function() {
					var url = '<c:url value='/assignmentManagement/RUACaseApproval/editQuotationRecord'/>';
	...
	<jsp:body>
        ...
        <section class="content">
        	<form id="mainForm" action="<c:url value='/assignmentManagement/RUACaseApproval/approveRejectQuotationRecord'/>" method="post" role="form"
	        		...
	        		<div class="col-md-12">
	        			...
	        			<div class="box box-primary">
	        				<div class="box-header with-border">
								<a class="btn btn-default btn-back" href="<c:url value='/assignmentManagement/RUACaseApproval/edit'/>?assignmentId=${model.assignmentId}">Back</a>
								<c:if test="${show}">
									...
									<div class="form-group">
										...
										<div class="col-md-5 custom-page-nav pull-right" style="text-align: right">
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/RUACaseApproval/editQuotationRecord'/>?quotationRecordId=${model.previousQuotationRecordId}"><i class="fa fa-caret-left"></i></a>
											</c:when>
											<c:otherwise>
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/RUACaseApproval/editQuotationRecord'/>?quotationRecordId=${model.nextQuotationRecordId}"><i class="fa fa-caret-right"></i></a>
											</c:when>
											<c:otherwise>
        	...
        	<div class="modal fade" id="rejectReasonForm" tabindex="-1" role="dialog" aria-labelledby="dialogLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="<c:url value='/assignmentManagement/RUACaseApproval/approveRejectQuotationRecord'/>" method="post" id="rejectReasonInputForm">
