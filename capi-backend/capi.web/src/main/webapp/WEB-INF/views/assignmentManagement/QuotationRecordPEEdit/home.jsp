...
<t:layout>
	...
	<jsp:body>
        ...
        <section class="content">
        	<form id="mainForm" action="<c:url value='/assignmentManagement/QuotationRecordPEEdit/submit'/>" method="post" role="form"
	        		...
	        		<div class="col-md-12">
	        			...
	        			<div class="box box-primary">
	        				<div class="box-header with-border">
								<div class="col-md-7">
									<span>Quotation ID: ${model.quotationId}</span>
								</div>
						...
						<div class="box box-primary">
							<div class="box-body">
								<div class="form-horizontal">
									<div class="form-group">
										<label class="col-md-1 control-label">PE Remark:</label>
										<div class="col-sm-11">
											<textarea id="peCheckRemark" name="peCheckRemark" class="form-control" type="text"><c:out value="${model.peCheckRemark}"/></textarea>
										</div>
									</div>
								</div>
							</div>
