...
<t:layout>
		...
		<script>
			$(function() {
				...
				$('.select-backtrack').change(function() {
					var url = '<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/editQuotationRecord'/>';
	...
	<jsp:body>
        ...
        <section class="content">
        	<form id="mainForm" action="<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/saveQuotationRecord'/>" method="post" role="form"
	        		...
	        		<div class="col-md-12">
	        			...
	        			<div class="box box-primary">
	        				<div class="box-header with-border">
								<a class="btn btn-default btn-back" href="<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/edit'/>?assignmentId=${model.assignmentId}">Back</a>
								<c:if test="${show}">
									...
									<div class="form-group">
										...
										<div class="col-md-5 custom-page-nav pull-right" style="text-align: right">
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/editQuotationRecord'/>?quotationRecordId=${model.previousQuotationRecordId}"><i class="fa fa-caret-left"></i></a>
											</c:when>
											<c:otherwise>
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/editQuotationRecord'/>?quotationRecordId=${model.nextQuotationRecordId}"><i class="fa fa-caret-right"></i></a>
											</c:when>
											<c:otherwise>
