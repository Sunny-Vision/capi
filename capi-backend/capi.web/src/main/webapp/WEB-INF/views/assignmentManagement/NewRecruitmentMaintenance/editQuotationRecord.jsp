...
<t:layout>
		...
		<script>
			$(function() {
				...
				$('.select-backtrack').change(function() {
					var url = '<c:url value='/assignmentManagement/NewRecruitmentMaintenance/editQuotationRecord'/>';
				...
				$('.btn-flag').click(function() {
					...
					$.post('<c:url value="/assignmentManagement/NewRecruitmentMaintenance/setQuotationRecordFlag"/>', {id: quotationRecordId, flag: flag}, function(result) {
	...
	<jsp:body>
        ...
        <section class="content">
        	<form id="mainForm" action="<c:url value='/assignmentManagement/NewRecruitmentMaintenance/saveQuotationRecord'/>" method="post" role="form"
	        		...
	        		<div class="col-md-12">
	        			...
	        			<div class="box box-primary">
	        				<div class="box-header with-border">
								<a class="btn btn-default btn-back" href="<c:url value='/assignmentManagement/NewRecruitmentMaintenance/edit'/>?assignmentId=${model.assignmentId}&userId=${model.userId}">Back</a>
								<c:if test="${show}">
									...
									<div class="form-group">
										...
										<div class="col-md-5 custom-page-nav pull-right" style="text-align: right">
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/NewRecruitmentMaintenance/editQuotationRecord'/>?quotationRecordId=${model.previousQuotationRecordId}"><i class="fa fa-caret-left"></i></a>
											</c:when>
											<c:otherwise>
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/NewRecruitmentMaintenance/editQuotationRecord'/>?quotationRecordId=${model.nextQuotationRecordId}"><i class="fa fa-caret-right"></i></a>
											</c:when>
											<c:otherwise>
	        			...
	        			<div class="box box-default">
	       					<div class="box-footer">
	       						<sec:authorize access="hasPermission(#user, 16) or hasPermission(#user, 256)">
	        						...
	        						<button name="btnSubmit" value="next" type="submit" class="btn btn-info">Next</button>
	        						</c:if>
	        						<c:if test="${model.previousQuotationRecordId != null}">
	        						<button name="btnSubmit" value="previous" type="submit" class="btn btn-info">Previous</button>
	        						</c:if>
