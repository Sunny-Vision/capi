...
<div class="box-body quotation-record-list-container">
			...
			<div class="consignment-counter-container hide">
				...
				<div class="col-md-2">
					<select name="consignmentCounter" class="form-control filters select2ajax"
						...
						data-ajax-url="<c:url value='/assignmentManagement/NewRecruitmentApproval/queryNormalConsignmentSelect2'/>?assignmentId=${model.assignmentId}"></select>
				</div>
			</div>
			<div class="unit-category-container hide">
				...
				<div class="col-md-2">
					<select name="unitCategory" class="form-control filters select2ajax"
						data-allow-clear="true"
						data-ajax-url="<c:url value='/assignmentManagement/NewRecruitmentApproval/queryNormalDistinctUnitCategorySelect2'/>?assignmentId=${model.assignmentId}"></select>
				</div>
			</div>
		</div>
	...
	<form id="frmSubmit" method="post" action="<c:url value='/assignmentManagement/NewRecruitmentApproval/approveRejectQuotationRecords'/>">
	...
	<table class="table table-striped table-bordered table-hover quotation-record-table"
		data-url="<c:url value="/assignmentManagement/NewRecruitmentApproval/queryNormalQuotationRecord"/>">
		<thead>
		<tr>
