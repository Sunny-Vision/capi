...
<div class="box-body quotation-record-list-container">
	<div class="form-horizontal">
		...
		<div class="col-md-2">
			<select name="consignmentCounter" class="form-control filters select2ajax"
				...
				data-ajax-url="<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/queryNormalConsignmentSelect2'/>?assignmentId=${model.assignmentId}&userId=${model.userId}"></select>
		</div>
		<div class="form-group">
			...
			<div class="col-md-2">
				<select name="unitCategory" class="form-control filters select2ajax"
					data-allow-clear="true"
					data-ajax-url="<c:url value='/assignmentManagement/PEViewAssignmentMaintenance/queryNormalDistinctUnitCategorySelect2'/>?assignmentId=${model.assignmentId}&userId=${model.userId}"></select>
			</div>
		</div>
	...
	<table class="table table-striped table-bordered table-hover quotation-record-table"
		data-url="<c:url value="/assignmentManagement/PEViewAssignmentMaintenance/queryNormalQuotationRecord"/>">
		<thead>
		<tr>
			<th>Variety</th>
			<th>NPrice</th>
