	...
	<jsp:attribute name="header">
		...
		<script>
			$(function() {
				...
				$('.select-backtrack').change(function() {
					var url = '<c:url value='/assignmentManagement/AssignmentApproval/editQuotationRecord'/>';
	...
	<jsp:body>
		<section class="content-header">
          <h1>Assignment Approval</h1>
			<div class="breadcrumb form-horizontal" style="width:250px">
        ...
        <section class="content">
        	<form id="mainForm" action="<c:url value='/assignmentManagement/AssignmentApproval/approveRejectQuotationRecord'/>" method="post" role="form"
        		enctype="multipart/form-data">
        		<input name="dirty" value="<c:out value="${model.dirty ? 'true' : 'false'}"/>" type="hidden"/>
        		<input name="quotationRecordId" value="<c:out value="${model.quotationRecord.originalQuotationRecord != null ? model.quotationRecord.originalQuotationRecord.id : model.quotationRecord.id}"/>" type="hidden"/>
	        	<div class="row">
	        		<div class="col-md-12">
	        			...
	        			<div class="box box-primary">
	        				<div class="box-header with-border">
								<a class="btn btn-default btn-back" href="<c:url value='/assignmentManagement/AssignmentApproval/home?keepSession=true'/>">Back</a>
								<c:if test="${show}">
									...
									<div class="form-group">
										...
										<div class="col-md-5 custom-page-nav pull-right" style="text-align: right">
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/AssignmentApproval/editQuotationRecord'/>?quotationRecordId=${model.previousQuotationRecordId}"><i class="fa fa-caret-left"></i></a>
											</c:when>
											<c:otherwise>
											...
											<a class="btn btn-default"
												href="<c:url value='/assignmentManagement/AssignmentApproval/editQuotationRecord'/>?quotationRecordId=${model.nextQuotationRecordId}"><i class="fa fa-caret-right"></i></a>
											</c:when>
											<c:otherwise>
        	...
        	<div class="modal fade" id="rejectReasonForm" tabindex="-1" role="dialog" aria-labelledby="dialogLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="<c:url value='/assignmentManagement/AssignmentApproval/approveRejectQuotationRecord'/>" method="post" id="rejectReasonInputForm">
