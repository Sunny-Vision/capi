		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                //"ajax": "<c:url value='/assignmentAllocationAndReallocation/AssignmentReallocationApproval/query'/>",
	                "ajax": {
	                	url: "<c:url value='/assignmentAllocationAndReallocation/AssignmentReallocationApproval/query'/>",
	                	method: "post"
	                },
	                "columns": [
	                            {
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		var html = "<a href='<c:url value='/assignmentAllocationAndReallocation/AssignmentReallocationApproval/edit'/>?id="+data+"&targetUserId="+full.targetFieldOfficerId+"' class='table-btn'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
	                            		return html;
                            		},
	                            	"className" : "text-center"
                            	}
