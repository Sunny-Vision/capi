...
<t:layout>
			...
			$(document).ready(function(){
				...
				function initTable() {
					...
					$dataTable.DataTable({
			            ...
			            "serverSide": true,
			            "ajax": {
			            	url: "<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/queryAssignment'/>",
	...
	<jsp:body>
		<section class="content-header">
          <h1>Assignment Transfer-in/out Recommendation</h1>
        </section>
        
        <section class="content">
        	<form id="mainForm" action="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/submit'/>" method="post" role="form"
					...
					<div class="col-md-12">
	        			<div class="box box-primary">
	        				<div class="box-header with-border">
								<a class="btn btn-default" href="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/home'/>">Back</a>
							</div>
	       					<div class="box-body">
								<!-- content -->
								<div class="row">
									...
									<div class="row" style="margin-top: 10px;">
										...
										<div class="col-md-3">
											<select id="tpuId" class="form-control select2ajax filters"
												...
												data-ajax-url="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/queryTpuSelect2'/>"
											></select>
										</div>
										...
										<div class="col-md-3">
											<select id="outletTypeId" class="form-control select2ajax filters"
												...
												data-allow-clear="true" 
												data-close-on-select="false"
												data-ajax-url="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/queryOutletTypeSelect2'/>"
											></select>
										</div>
									</div>
									<div class="row" style="margin-top: 10px;">
										...
										<div class="col-md-3">
											<select id="districtId" class="form-control select2ajax filters"
												data-allow-clear="true"
												data-ajax-url="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/queryDistrictSelect2'/>"></select>
										</div>
										<label class="col-md-2 control-label">Batch Code</label>
										<div class="col-md-3">
											<select id="batchId" class="form-control select2ajax filters"
												data-allow-clear="true"
												data-ajax-url="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/queryBatchSelect2'/>"></select>
										</div>
									</div>
								</div>
								<div class="row">
