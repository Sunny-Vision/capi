		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
		            ...
		            "serverSide": true,
		            "ajax": {
		            	url: "<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/query'/>",
		            ...
		            "columns": [
		                        ...
		                        { "data": "id",
		                        	"render": function(data) {
		                        		return "<a href='<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/edit?id='/>"+data+"' class='table-btn'><span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span></a>";
		                        	}
		                        }
								],
								...
								<div class="row">
									...
									<div class="col-md-3">
										<select name="fromUserId" class="form-control select2 filters"
											data-ajax-url="<c:url value='/assignmentAllocationAndReallocation/AssignmentTransferInOutRecommendation/queryOfficerSelect2'/>"
