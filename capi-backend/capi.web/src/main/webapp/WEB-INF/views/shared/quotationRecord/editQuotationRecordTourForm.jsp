...
<div class="form-horizontal quotation-record-form ${quotationRecord.backNo ? 'back-no' : 'original active'}" ${model.readonly ? 'disabled': ''}>
	...
	<br/>
	<table class="table table-striped table-bordered table-hover extra-price-table">
		<tbody>
			<tr>
	...
	<div class="form-group">
		<div class="btn-copy copy-name-value btn-copy-nprice ${model.history ? '' : 'hide'}"><i class="fa fa-copy"></i></div>
	...
	<c:if test="${(not empty model.isHiddenFieldOfficer and not model.isHiddenFieldOfficer) or model.history}">
