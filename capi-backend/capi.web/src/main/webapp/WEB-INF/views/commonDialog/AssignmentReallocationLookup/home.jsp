	...
	<div class="modal-dialog modal-xlg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Search Assignment Reallocation</h4>
			</div>
					...
					<div class="row" style="margin-top: 10px;">
						...
						<div class="col-md-3">
							<select name="outletTypeId" class="form-control select2ajax filters"
								data-ajax-url="<c:url value='/commonDialog/AssignmentReallocationLookup/queryOutletTypeSelect2'/>"
							></select>
						</div>
					</div>
					<div class="row" style="margin-top: 10px;">
						...
						<div class="col-md-3">
							<select name="districtId" class="form-control select2ajax filters" id="districtId"
								data-ajax-url="<c:url value='/commonDialog/AssignmentReallocationLookup/queryDistrictSelect2'/>"/></select>
						</div>
						<label class="col-md-2 control-label">Batch Code</label>
						<div class="col-md-3">
							<select name="batchId" class="form-control select2ajax filters" id="batchId"
								data-ajax-url="<c:url value='/commonDialog/AssignmentReallocationLookup/queryBatchSelect2'/>"/></select>
						</div>
					</div>
					<div class="row" style="margin-top: 10px;">
					...
					<div class="row" style="margin-top: 10px;">
						...
						<div class="col-md-3">
							<select name="surveyMonthId" class="form-control select2ajax filters" id="surveyMonthId"
								data-ajax-url="<c:url value='/commonDialog/AssignmentReallocationLookup/querySurveyMonthSelect2'/>"/></select>
						</div>
					</div>
				</form>
