	...
	<jsp:attribute name="header">
		...
		$(document).ready(function(){
			...
			$('[name="referenceMonthStr"]').on("change", function(){
				$.ajax({
					type: 'POST',
					url: "<c:url value='/dataConversion/QuotationRecordDataConversion/getSurveyMonthDetails'/>",
	...
	<jsp:body>
        ...
        <section class="content">
        	<div class="row">
				<div class="col-md-12" >
				<!-- content -->
					<form class="form-horizontal" action="<c:url value='/dataConversion/QuotationRecordDataConversion/selectSurveyType'/>" role="form" id="mainForm">
						<div class="box" >
