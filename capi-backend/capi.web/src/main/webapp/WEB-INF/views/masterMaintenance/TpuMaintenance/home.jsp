		...
		<script>
			function deleteRecordsWithConfirm(data) {
				bootbox.confirm({
					...
					callback: function(result){
						if (result){
							$.post("<c:url value='/masterMaintenance/TpuMaintenance/delete'/>",
								data,
								function(response) {
			...
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"buttons": [
						{
							...
							"action": function( nButton, oConfig, flash ) {
								window.location = "<c:url value='/masterMaintenance/TpuMaintenance/edit?act=add'/>";
							}
						},
						{
							"text": "Delete",
	                ...
	                "serverSide": true,
	                "ajax": {
	                	url: "<c:url value='/masterMaintenance/TpuMaintenance/query'/>",
	                	method: "post",
	                	data: function(d) {
	                ...
	                "columns": [
	                            ...
	                            {
	                            	"data": "districtChineseName",
	                            	"orderable": true,
	                            	"searchable": true,
	                            	"className" : "text-center"
	                            },
	                            {
	                            	"data": "districtEnglishName",
	                            	"orderable": true,
	                            	"searchable": true,
	                            	"className" : "text-center"
	                            },
	                            ...
	                            },
	                            {
	                            	...
	                            	"searchable": false,
	                            	"render" : function(data, type, full, meta){
	                            		var html = "<a href='<c:url value='/masterMaintenance/TpuMaintenance/edit?act=edit&id='/>"+data+"' class='table-btn'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
	                            		<sec:authorize access="hasPermission(#user, 256)">
	...
	<jsp:body>
        ...
        <section class="content">
        	<div class="row">
				<div class="col-md-12" >
				<!-- content -->
					<form action="<c:url value="/masterMaintenance/TpuMaintenance/delete" />" id="dataForm" method="post">
							...
							<div class="box-body">
								...
								<div class="form-horizontal">
									<div class="row">
										...
										<div class="col-md-2">
											<select class="form-control select2 filters" id="districtId" 
											data-ajax-url="<c:url value='/masterMaintenance/TpuMaintenance/queryDistrictSelect'/>"></select>
										</div>
									</div>
								</div>
								...
								<table class="table table-striped table-bordered table-hover" id="dataList">
									...
									<tr>
										...
										<th>TPU Code</th>
										<th>District Code</th>
										<th>District Chinese Name</th>
										<th>District English Name</th>
										<th>District Council District</th>
