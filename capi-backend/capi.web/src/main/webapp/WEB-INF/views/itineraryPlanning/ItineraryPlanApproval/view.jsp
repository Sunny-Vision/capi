	        		...
	        		<div class="col-md-12">
	        			...
	        			<div class="box box-primary">
	        				...
	        				<sec:authorize access="hasPermission(#user, 1) or hasPermission(#user, 2) or hasPermission(#user, 4) or hasPermission(#user, 256)">
	        					<a class="btn btn-default pull-right" href="<c:url value='/itineraryPlanning/ItineraryPlan/edit?id='/><c:out value="${model.itineraryPlanId}" />" >Edit</a>
							</sec:authorize>
								<a class="btn btn-default" href="<c:url value='/itineraryPlanning/ItineraryPlanApproval/home'/>">Back</a>
							</div>
	       					<div class="box-body">
	       						<div class="form-horizontal">
       								<div class="col-md-2"><label>Date: </label><c:out value="${commonService.formatDate(model.date)}" /></div>
       								<div class="col-md-2"><label>Field Officer: </label><c:out value="${user.staffCode}" /></div>
  									...
  									<div class="form-group">
										...
										<div class="col-sm-12" >
       							   	...
       							   	<div class="col-md-12" id="sessions">
       							   		<label id="labelSession_1" class="control-label">A Session:</label>
       							   		 <ul class="list-group">
       							   		...
       							   		<label id="labelSession_3" class="control-label">E Session:</label>
       							   		<ul class="list-group">
       							   			<li class="col-md-12 list-group-item">
					...
					<div class="modal-content">
						<div  class="clearfix overlay" data-bind="loading:isLoading, visible:isLoading" ></div>						
							<div class="modal-header">
								...
								<h4 class="modal-title" id="dialogLabel" >Reject Dialog</h4>
							</div>
