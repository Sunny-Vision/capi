		...
		<script>
			function approveRecordsWithConfirm(data) {
				bootbox.confirm({
					...
					callback: function(result){
						if (result){
							$.post("<c:url value='/qualityControlManagement/SupervisoryVisitApproval/approveAtHome'/>",
								data,
								function(response) {
			...
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                //"ajax": "<c:url value='/qualityControlManagement/SupervisoryVisitApproval/query'/>",
	                "ajax": {
	                	url: "<c:url value='/qualityControlManagement/SupervisoryVisitApproval/query'/>",
	                	method: "post"
	                },
	                "columns": [
								{
	                            ...
	                            },
	                            {
	                            	...
	                            	"searchable": false,
	                            	"render" : function(data, type, full, meta){
	                            		var html = "<a href='<c:url value='/qualityControlManagement/SupervisoryVisitApproval/edit'/>?act=edit&id="+data+"&fieldOfficer="+full.fieldOfficer+"' class='table-btn'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
	                            		return html;
                            		},
	                            	"className" : "text-center"
                            	}
	...
	<jsp:body>
        ...
        <section class="content">
        	<div class="row">
				<div class="col-md-12" >
				<!-- content -->
						<!-- Supervisory Visit Approval Table -->
						<div class="box" >
							<div class="box-body">
        ...
        <div class="modal fade" id="rejectReasonForm" tabindex="-1" role="dialog" aria-labelledby="dialogLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="<c:url value='/qualityControlManagement/SupervisoryVisitApproval/rejectAtHome'/>" method="post" id="rejectReasonInputForm">
