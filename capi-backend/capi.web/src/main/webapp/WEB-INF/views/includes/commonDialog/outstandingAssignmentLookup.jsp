...
<script>
(function ($) {
	$.fn.outstandingAssignmentLookup = function(opts) {
		var $input = this;
		var _def = {
			multiple: true,
			popupUrl: "<c:url value='/commonDialog/OutstandingAssignmentLookup/home'/>",
			queryUrl: "<c:url value='/commonDialog/OutstandingAssignmentLookup/query'/>",
			selectAllUrl: "<c:url value='/commonDialog/OutstandingAssignmentLookup/getLookupTableSelectAll'/>",
			defaultOrder: [[ 1, "asc" ]],
