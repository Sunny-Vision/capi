...
(function($, undefined){
	...
	Plugin.prototype = {
		...
		_showPopup: function() {
			...
			if (this.$popupModal == null) {
				...
				$.get(plugin.o.popupUrl + '?productId=' + plugin.o.productId, function(html) {
					var $html = $(html);
	...
	$.fn.productSpecDialog = function(option) {
		var pluginDataName = 'productSpecDialog';
	...
	$.fn.productSpecDialog.Constructor = Plugin;

	var defaults = $.fn.productSpecDialog.defaults = {
		popupUrl: "<c:url value='/commonDialog/ProductSpecDialog/home'/>",
		productId: null
	};
}(window.jQuery));
</script>