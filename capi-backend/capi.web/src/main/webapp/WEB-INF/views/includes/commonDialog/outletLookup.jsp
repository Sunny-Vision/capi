...
(function($, undefined){
	...
	Plugin.prototype = {
		...
		_initPopup: function() {
			...
			plugin.$popupTable.DataTable({
	            ...
	            "ajax": {
	            	...
	            	data: function(dataModel) {
	            		...
	            		dataModel.tpuId = $('[name="tpuId"]', plugin.$popupModal).val();
	            		dataModel.activeOutlet = '';
			...
			$('[name="tpuId"]', plugin.$popupModal).select2ajax({
				width:'100%',
				ajax: {
				    data: function (params) {
				    	params.districtId = $('[name="districtId"]', plugin.$popupModal).val()
				    	return params;
					},
					method: 'GET',
	...
	$.fn.outletLookup = function(option) {
		var pluginDataName = 'outletLookup';
	...
	$.fn.outletLookup.Constructor = Plugin;

	var defaults = $.fn.outletLookup.defaults = {
		multiple: true,
		popupUrl: "<c:url value='/commonDialog/OutletLookup/home'/>",
		queryUrl: "<c:url value='/commonDialog/OutletLookup/query'/>",
		selectAllUrl: "<c:url value='/commonDialog/OutletLookup/getLookupTableSelectAll'/>",
		defaultOrder: [[ 1, "asc" ]],
