...
(function($, undefined){
	...
	Plugin.prototype = {
		...
		_initPopup: function() {
		    ...
		    $('[name="purposeId"]', plugin.$popupModal).select2({
				width:'100%',
				placeholder: "",
				allowClear: true,
				closeOnSelect: false
			});
		    $('[name="outletTypeId"]', plugin.$popupModal).select2({
				width:'100%',
				placeholder: "",
				allowClear: true,
				closeOnSelect: false
	...
	$.fn.quotationLookup = function(option) {
		var pluginDataName = 'quotationLookup';
	...
	$.fn.quotationLookup.Constructor = Plugin;

	var defaults = $.fn.quotationLookup.defaults = {
		multiple: true,
		popupUrl: "<c:url value='/commonDialog/QuotationLookup/home'/>",
		queryUrl: "<c:url value='/commonDialog/QuotationLookup/query'/>",
		selectAllUrl: "<c:url value='/commonDialog/QuotationLookup/getLookupTableSelectAll'/>",
		defaultOrder: [[ 1, "asc" ]],
