...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/SummaryOfNightSession/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/SummaryOfNightSession/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
	...
	<jsp:body>
		<section class="content-header">
          <h1>Summary Of Night Sessions</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters"> 
								<form class="form-horizontal" action="<c:url value="/report/SummaryOfNightSession/submitReportRequest"/>" id="criteriaForm" method="post">
											...
											<div class="col-md-5">
												<div class="input-group">
													...
													<select multiple name="officerIds" id="userId" class="select2ajax filters"
														...
														data-placeholder=""
														data-ajax-url="<c:url value='/report/SummaryOfNightSession/queryOfficerSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/SummaryOfNightSession/queryUserSelectMutiple'/>"
													></select>
