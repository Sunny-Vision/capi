...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/SummaryOfTimeoffOvertime/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/SummaryOfTimeoffOvertime/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
					...
					ajax: {
						...
						data: function(term) {
							return $.extend(term, {authorityLevel:${authorityLevel}}, {endDate:$('[name="fromDate"]').val()}
								, {startDate:$('[name="toDate"]').val()}, {userIds: ${userIds} }, {staffType: 1});
						}
					}
				});
	...
	<jsp:body>
		<section class="content-header">
          <h1>Summary of Time off / Over time (by Individual Field Officer)</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/SummaryOfTimeoffOvertime/submitReportRequest" />" id="criteriaForm" method="post">
												...
												<div class="col-md-5">
													<div class="input-group">
														<select multiple name="officerIds" id="userId" class="select2ajax filters"
															...
															data-placeholder=""
															data-ajax-url="<c:url value='/report/SummaryOfTimeoffOvertime/queryOfficerSelect2'/>"
															data-get-key-value-by-ids-url="<c:url value='/report/SummaryOfTimeoffOvertime/queryUserSelectMutiple'/>"
														></select>
