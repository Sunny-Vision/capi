...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/RUACaseReportOverview/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/RUACaseReportOverview/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
	...
	<jsp:body>
		<section class="content-header">
          <h1>RUA Case Report (Overview by Individual Field Officer & District)</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters"> 
								<form class="form-horizontal" action="<c:url value="/report/RUACaseReportOverview/submitReportRequest"/>" id="criteriaForm" method="post">
											...
											<div class="col-md-5">
												<div class="input-group">
													...
													<select multiple name="officerIds" id="userId" class="select2ajax filters"
														...
														data-placeholder=""
														data-ajax-url="<c:url value='/report/RUACaseReportOverview/queryOfficerSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/RUACaseReportOverview/queryUserSelectMutiple'/>"
													></select>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<select name="districtIds" class="form-control select2ajax filters" multiple id="districtIds"
													data-ajax-url="<c:url value='/report/RUACaseReportOverview/queryDistrictSelect2'/>"></select>
											</div>
										</div>
										<div class="form-group">
