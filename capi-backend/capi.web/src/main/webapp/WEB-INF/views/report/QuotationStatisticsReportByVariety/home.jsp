...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/QuotationStatisticsReportByVariety/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/QuotationStatisticsReportByVariety/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
				...
				*/
				...
				$('[name="quotationId"]').select2ajax({
					ajax: {
					    data: function (term) {
					    	return $.extend(term, {unitId: $('[name="itemId"]').val(), 
	...
	<jsp:body>
		<section class="content-header">
          <h1>Quotation Statistics Report (By Variety) report</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/QuotationStatisticsReportByVariety/submitReportRequest" />" id="criteriaForm" method="post">
									<div class="form-group">
										<label class="col-md-2 control-label">Purpose:</label>
										<div class="col-md-5">
											<select name="purpose" class="form-control select2ajax filters" multiple
												data-ajax-url="<c:url value='/report/QuotationStatisticsReportByVariety/queryPurposeSelect2'/>"></select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="input-group">
												<select name="itemId" class="form-control filters"
													...
													data-placeholder=""
													data-ajax-url="<c:url value='/report/QuotationStatisticsReportByVariety/queryUnitSelect2'/>"
													data-get-key-value-by-ids-url="<c:url value='/report/QuotationStatisticsReportByVariety/getKeyValueByIds'/>"
											...
											<div class="col-md-5">
												<div class="input-group">
													<select name="quotationId" class="form-control filters"
														style="display:none"
														data-ajax-url="<c:url value='/report/QuotationStatisticsReportByVariety/queryQuotationSelect2'/>"
														data-allow-clear="true"
														data-placeholder=""
														data-close-on-select="false"
														multiple></select>
