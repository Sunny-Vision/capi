...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/ProductCycleReportByVariety/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/ProductCycleReportByVariety/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
	...
	<jsp:body>
		<section class="content-header">
          <h1>Product Cycle Report (by Variety)</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/ProductCycleReportByVariety/submitReportRequest" />" id="criteriaForm" method="post">
									
										<div class="form-group">
											<label class="col-md-2 control-label">Purpose:</label>
											<div class="col-md-5">
												<select name="purpose" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/ProductCycleReportByVariety/queryPurposeSelect2'/>"></select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group">
													<select name="unitId" class="form-control filters"
														...
														data-placeholder=""
														data-ajax-url="<c:url value='/report/ProductCycleReportByVariety/queryUnitSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/ProductCycleReportByVariety/getKeyValueByIds'/>"
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<select name="productGroup" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/ProductCycleReportByVariety/queryProductCategorySelect2'/>"></select>
											</div>
										</div>
										<div class="form-group">
