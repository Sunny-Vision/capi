		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/AirportTicketPRListByCountryWithCPISeries/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/AirportTicketPRListByCountryWithCPISeries/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
...
// 				});
	...
	<jsp:body>
		<section class="content-header">
          <h1>Airport Ticket PR List By Country With CPI Series report</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/AirportTicketPRListByCountryWithCPISeries/submitReportRequest" />" id="criteriaForm" method="post">
									
										<div class="form-group">
											<label class="col-md-2 control-label">Purpose:</label>
											<div class="col-md-5">
												<select name="purpose" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/AirportTicketPRListByCountryWithCPISeries/queryPurposeSelect2'/>"></select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												...
												<!--2018-01-04 chenug_cheng [MB9010]  The lookup table should show up to item level only  -->
													<select name="itemId" class="form-control filters"
														...
														data-placeholder=""
														data-ajax-url="<c:url value='/report/AirportTicketPRListByCountryWithCPISeries/queryUnitSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/AirportTicketPRListByCountryWithCPISeries/getKeyValueByIds'/>"
										...
										<div class="form-group">
											<label class="col-md-2 control-label">CPI Compilation Series:</label>
											<div class="col-md-5">
												<select name="quotationFormType" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/AirportTicketPRListByCountryWithCPISeries/queryCpiCompilationSeriesSelect2'/>"
													></select>
											</div>
										</div>
										<div class="form-group">
