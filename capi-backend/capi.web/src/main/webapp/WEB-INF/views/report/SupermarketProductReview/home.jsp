...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/SupermarketProductReview/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/SupermarketProductReview/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
	...
	<jsp:body>
		<section class="content-header">
          <h1>Supermarket Product Review</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/SupermarketProductReview/submitReportRequest" />" id="criteriaForm" method="post">
									<div class="form-group">
										<label class="col-md-2 control-label">Purpose:</label>
										<div class="col-md-5">
											<select name="purpose" class="form-control select2ajax filters" multiple
												data-ajax-url="<c:url value='/report/SupermarketProductReview/queryPurposeSelect2'/>"></select>
										</div>
									</div>
									<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group">
													<%-- <select name="unitId" class="form-control filters"
														...
														data-placeholder=""
														data-ajax-url="<c:url value='/report/SupermarketProductReview/queryUnitSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/SupermarketProductReview/getKeyValueByIds'/>"
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Price remarks (Quotation Record):</label>
										<div class="col-md-5">
											<select name="priceRemarks" class="form-control select2 filters">
												<option></option>
												<option value="Y">Not Null</option>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Data Conversion Remarks:</label>
										<div class="col-md-5">
											<select name="dataConversionRemarks" class="form-control select2 filters">
												<option></option>
												<option value="Y">Not Null</option>
												<option value="N">Null</option>
												<option value="ALL">All</option>
