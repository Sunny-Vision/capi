...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/ApplicationTimeOff/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/ApplicationTimeOff/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
				...
				function updateDatePicker(){
					...
					$.post("<c:url value='/report/ApplicationTimeOff/getStaffTimeOffDates' />", {userId: userId}, function (data){
						events = [];
						for (i = 0; i < data.length; i++){
	...
	<jsp:body>
		<section class="content-header">
          <h1>Application for Time-off in Lieu</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/ApplicationTimeOff/submitReportRequest"/>" id="criteriaForm" method="post">
												...
												<div class="col-md-5">
													<div class="input-group">
														<select id="userId" class="select2ajax filters"
															...
															data-placeholder=""
															data-ajax-url="<c:url value='/report/ApplicationTimeOff/queryOfficerSelect2'/>"
															data-get-key-value-by-ids-url="<c:url value='/report/ApplicationTimeOff/queryUserSelectMutiple'/>"
															required
														></select>
