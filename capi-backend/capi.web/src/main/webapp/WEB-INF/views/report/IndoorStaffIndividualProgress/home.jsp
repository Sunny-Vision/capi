...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/IndoorStaffIndividualProgress/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/IndoorStaffIndividualProgress/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
	...
	<jsp:body>
		<section class="content-header">
          <h1>Indoor Staff Progress report (Individual)</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters">
								<form class="form-horizontal" action="<c:url value="/report/IndoorStaffIndividualProgress/submitReportRequest" />" id="criteriaForm" method="post">
									
										<div class="form-group">
											<label class="col-md-2 control-label">Purpose:</label>
											<div class="col-md-5">
												<select name="purpose" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/IndoorStaffIndividualProgress/queryPurposeSelect2'/>"></select>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group">
													<select name="batch" class="form-control select2ajax filters" multiple id="batchCodeIds"
														data-single-url="<c:url value="/userAccountManagement/StaffProfileMaintenance/getBatchCodes" />"
														data-ajax-url="<c:url value='/report/IndoorStaffIndividualProgress/queryBatchSelect2'/>"></select>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group">
													<select name="subGroup" class="form-control filters"
														data-allow-clear="true"
														data-placeholder=""
														data-ajax-url="<c:url value='/report/IndoorStaffIndividualProgress/queryUnitSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/IndoorStaffIndividualProgress/getKeyValueByIds'/>"
														data-close-on-select="false"
														multiple></select>
													<div id="unitLookup" class="input-group-addon lookup"
														data-bottom-entity-class="SubGroup">
														<i class="fa fa-search"></i>
													</div>
												</div>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<select name="cpiBasePeriods" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/IndoorStaffIndividualProgress/queryCPIBasePeriodSelect2'/>"></select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group">
													<select multiple name="userId" id="userId" class=" filters"
														data-allow-clear="true"
														data-placeholder=""
														data-ajax-url="<c:url value='/report/IndoorStaffIndividualProgress/queryOfficerSelect2'/>"
														data-get-key-value-by-ids-url="<c:url value='/report/IndoorStaffIndividualProgress/queryUserSelectMutiple'/>"
													></select>
