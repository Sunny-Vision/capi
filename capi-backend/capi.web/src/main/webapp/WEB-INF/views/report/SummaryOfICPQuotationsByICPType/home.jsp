...
<t:layout>
		...
		<script>
			$(document).ready(function(){
				...
				$dataTable.DataTable({
					...
					"processing": true,
	                "serverSide": true,
	                "ajax": "<c:url value='/report/SummaryOfICPQuotationsByICPType/query'/>",
	                "columns": [
	                            ...
	                            },
	                            {
	                            	...
	                            	"render" : function(data, type, full, meta){
	                            		if (data == "Finished"){
	                            			return "<a href='<c:url value='/report/SummaryOfICPQuotationsByICPType/downloadFile?id='/>"+full.reportTaskId+"' class='table-btn'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
	                            		}
	                            		else{
	                            			return data;
	                            		}
	...
	<jsp:body>
		<section class="content-header">
          <h1>Summary Of ICP Quotations By ICP Type</h1>
        </section>
				...
				<!-- content -->
					<div class="box" >
						<div class="box-body">
							...
							<div id="filters"> 
								<form class="form-horizontal" action="<c:url value="/report/SummaryOfICPQuotationsByICPType/submitReportRequest"/>" id="criteriaForm" method="post">
										
										<div class="form-group">
											<label class="col-md-2 control-label">ICP Type:</label>
											<div class="col-md-5">
												<select name="icpType" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/SummaryOfICPQuotationsByICPType/queryUnitICPTypeSelect2'/>"></select>
											</div>
										</div>
<!-- 										<div class="form-group"> -->
<!-- 											<label class="col-md-2 control-label">ICP Code:</label> -->
<!-- 											<div class="col-md-5"> -->
<!-- 												<select name="unitId" class="form-control select2ajax filters" multiple -->
<%-- 													data-ajax-url="<c:url value='/report/SummaryOfICPQuotationsByICPType/queryUnitSelect2'/>"></select> --%>
<!-- 											</div> -->
<!-- 										</div> -->
										<div class="form-group">
											...
											<div class="col-md-5">
												<select name="icpProductCode" class="form-control select2ajax filters" multiple
													data-ajax-url="<c:url value='/report/SummaryOfICPQuotationsByICPType/queryQuotationICPProductCodeSelect2'/>"></select>
											</div>
										</div>
