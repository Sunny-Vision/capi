...
public class SummarySectionStatistic {

	private String sectionStatisticId;
	...
	public String getSectionStatisticId() {
		return sectionStatisticId;
	}

	public void setSectionStatisticId(String sectionStatisticId) {
