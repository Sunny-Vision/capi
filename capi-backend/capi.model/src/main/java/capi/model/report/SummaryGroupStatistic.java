...
public class SummaryGroupStatistic {
	
	private String groupStatisticId;
	...
	public String getGroupStatisticId() {
		return groupStatisticId;
	}

	public void setGroupStatisticId(String groupStatisticId) {
