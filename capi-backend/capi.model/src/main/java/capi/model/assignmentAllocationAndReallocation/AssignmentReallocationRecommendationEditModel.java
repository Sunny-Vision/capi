...
public class AssignmentReallocationRecommendationEditModel {
	...
	private Integer submitToApproveId;

	private String submitToApprove;
	...
	public Integer getSubmitToApproveId() {
		return submitToApproveId;
	}

	public void setSubmitToApproveId(Integer submitToApproveId) {
		this.submitToApproveId = submitToApproveId;
	}

	public String getSubmitToApprove() {
		return submitToApprove;
	}

	public void setSubmitToApprove(String submitToApprove) {
